...
try:
    from road_quality_monitor.constants import CLASS_NAMES, SEVERITY_BGR, ROAD_DAMAGE_CLASSES
except ImportError:
    try:
        from constants import CLASS_NAMES, SEVERITY_BGR, ROAD_DAMAGE_CLASSES
    except ImportError:
